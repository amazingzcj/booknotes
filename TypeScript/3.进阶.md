...
// index.ts(1,38): error TS2474: In 'const' enum declarations member initializer mus
```
...
let a = new Animal('Kitty'); // setter: Kittya.name = 'Tom'; // setter: Tomconsole.log(a.name); // Jack
```
